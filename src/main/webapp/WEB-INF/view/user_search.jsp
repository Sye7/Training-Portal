...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<div class="w3-container w3-light-grey w3-padding-32 w3-padding-large"
			...
			<div class="w3-content" style="max-width: 600px">
				...
				<div class="w3-section">
						<f:form class="example" modelAttribute="contact" action="search_result">
					<f:input path="contact" placeholder="Search.." name="search" required="true"/>
					<button type="submit" >
						<i class="fa fa-search"></i>
					</button>
				</f:form>
					</div>
					<span style="color: red"><label>${message}</label><f:errors path="courseName"></f:errors></span>
		...
		<h4 class="w3-center w3-padding-24">Enhance Your Learning !!!</h4>
			...
			<div class="w3-half" style="padding: 25px 25px 25px 25px;">
				<ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
					...
					<li class="w3-light-grey w3-padding-24">
						...
						href="CourseDetailsShow?courseId=${p.courseId}">
							<button type="submit" class="w3-button w3-white w3-padding-large">Details</button>
