...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<h4 class="w3-center w3-padding-24">User FeedBacks</h4>
		...
		<c:forEach var="p" items="${plist}">
			...
			<div
				...
				style="margin-left: 4%; margin-top:3% ;margin-right: 4%; margin-bottom: 1px"
				id="about">
				...
				<div class="w3-content w3-justify" style="max-width: 95%">
					...
					<div class="w3-white">
						<div class="w3-container w3-padding-small w3-center w3-white">
							<p >${p.feedback}</p>
						</div>
					</div>
