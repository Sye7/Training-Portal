...
//////////////////////////////////////////////////////////////
	...
	public String getPaymentGateway(@RequestParam long courseId, ModelMap map)
	{
	
		Random rand= new Random();
		int price = rand.nextInt(4000-2000)+2000;
...
//////////////////////////////////////////////////////////////
	...
	public String enroll(@ModelAttribute("course") Course course,
			HttpServletRequest request, Model model) {
////////////////////////////////////////////////
		long courseId = Integer.parseInt(request.getParameter("submit"));
...
//////////////////////////////////////////////////////////////
		...
		List<Course> plist = courseRepository.findByCourseIdIn(list);
		model.addAttribute("plist", plist);
		model.addAttribute("successful","You Have Successfully Enrolled in this course");
