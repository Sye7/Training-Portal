...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<nav
		...
		<a href="http://localhost:9090/user/user_search" onclick="w3_close()"
			class="w3-bar-item w3-button">Search Course</a> <a
			href="http://localhost:9090/user/user_enrolled_courses"
			onclick="w3_close()" class="w3-bar-item w3-button">My Courses</a> <a
			href="http://localhost:9090/user/userAssessmentsList?"
			onclick="w3_close()" class="w3-bar-item w3-button">Assessment
			Board</a> <a href="http://localhost:9090/user/logOut"
			onclick="w3_close()" class="w3-bar-item w3-button">Log Out</a>
	</nav>
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<h4 class="w3-center w3-padding-24" id='fadeout'> ${successful}</h4>
		...
		<c:forEach var="p" items="${plist}">
			<div class="w3-half" style="padding: 25px 25px 25px 25px;">
				<ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
					...
					String s1 = "";
					if (list.size() > 0)
						s1 = list.get(0).getSkillName();
					String s2 = "";
					if (list.size() > 1)
						s2 = list.get(1).getSkillName();
					%>
					<li class="w3-padding-16"><%=s1%></li>
					<li class="w3-padding-16"><%=s2%></li>
					<!-- end skills -->
